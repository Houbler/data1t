...
Этот проект состоит из:
 - Тетради Jupyter.
	[Python_scripts](pandas.ipynb)
 - Docker-файл для запуска базы.
	[Docker](docker-compose.yml)
 - SQL-скрипт для создания пустой таблицы.
	[DDL](db/DDL.sql)